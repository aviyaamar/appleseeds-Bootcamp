...
console.log(funcFind(numbers, 100));
...
const findGreater = (arr, number) => {
  ...
  const inventory = [
    ...
    const funcFindFrutis = (arr, fruit)=>{
        return arr.find((el) => {
            return el.fruit === fruit;
        });
    };
    console.log(funcFindFrutis(inventory, "bananas"));
